...
execute as @a[scores = {uncuredDeath = 1..}, nbt = !{ActiveEffects:[{Id: 2b}]}] run effect give @s minecraft:slowness 1000000 1 true
execute as @a[scores = {uncuredDeath = 1..}, nbt = !{ActiveEffects:[{Id: 2b}]}] run effect give @s minecraft:weakness 1000000 0 true
